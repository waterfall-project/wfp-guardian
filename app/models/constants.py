...
# Permission model field lengths
PERMISSION_NAME_MAX_LENGTH = 200  # service:resource_name:operation
PERMISSION_SERVICE_MAX_LENGTH = 50
PERMISSION_RESOURCE_NAME_MAX_LENGTH = 100
PERMISSION_OPERATION_MAX_LENGTH = 20
PERMISSION_DESCRIPTION_MAX_LENGTH = 500

# Policy model field lengths
POLICY_NAME_MAX_LENGTH = 100
POLICY_DISPLAY_NAME_MAX_LENGTH = 200
POLICY_DESCRIPTION_MAX_LENGTH = 500

# Role model field lengths
ROLE_NAME_MAX_LENGTH = 100
ROLE_DISPLAY_NAME_MAX_LENGTH = 200
